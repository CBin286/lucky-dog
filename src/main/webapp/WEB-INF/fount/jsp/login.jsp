...
<div class="layui-main login">
    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/user/login"  method="post" enctype="application/x-www-form-urlencoded" >
        ...
        <div class="layui-form-item">
            ...
            <a href="${pageContext.request.contextPath}/user/path/reg">注册新用户>>></a>
        </div>
